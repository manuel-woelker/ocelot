...
This document describes the testing expectations for `ocelot`.
...
Use `ocelot_pal::pal_mock::PalMock` when the code depends on platform behavior such as:
...
# What should be verified for compiler and tooling changes?

Compiler and tooling changes should usually verify:
